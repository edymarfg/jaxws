    ...
    extends Service
{
    ...
    private static final URL ATENDECLIENTESERVICE_WSDL_LOCATION;
    private static final WebServiceException ATENDECLIENTESERVICE_EXCEPTION;
    private static final QName ATENDECLIENTESERVICE_QNAME = new QName("http://cliente.bean.master.sigep.bsb.correios.com.br/", "AtendeClienteService");
