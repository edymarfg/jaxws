...
public class PreListaPostagem {
     ...
     * This is why there is not a {@code set} method for the objetosPostais property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the plpXml property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the plpXmlRetorno property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
