...
public class GerenteConta {
     ...
     * This is why there is not a {@code set} method for the clientesVisiveis property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the clientesVisiveis property.
     */
    public List<ClienteERP> getClientesVisiveis() {
        if (clientesVisiveis == null) {
            clientesVisiveis = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the usuariosInstalacao property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
